...
productos_demo = [
    { 'id': 1, 'nombre': 'Figura Goku Ultra Instinto', 'categoria': 'Figuras Coleccionables', 'precio': 85.00, 'stock': 5, 'estado': 'Disponible' },
    { 'id': 2, 'nombre': 'Tanque Sherman WWII 1:35', 'categoria': 'Modelos a Escala', 'precio': 120.00, 'stock': 3, 'estado': 'Disponible' },
    { 'id': 3, 'nombre': 'Impresion 3D Dragon Personalizado', 'categoria': 'Impresiones 3D', 'precio': 60.00, 'stock': 8, 'estado': 'Disponible' },
    { 'id': 4, 'nombre': 'Figura Naruto Sage Mode', 'categoria': 'Figuras Coleccionables', 'precio': 95.00, 'stock': 2, 'estado': 'Ultimas unidades' },
    { 'id': 5, 'nombre': 'Busto Iron Man Pintado', 'categoria': 'Pintura Profesional', 'precio': 150.00, 'stock': 1, 'estado': 'Ultimas unidades' },
    { 'id': 6, 'nombre': 'Restauracion Figura Vintage', 'categoria': 'Restauracion', 'precio': 45.00, 'stock': 10, 'estado': 'Disponible' },
]
...
def facturacion():
    ...
    return render_template('facturacion.html', facturas=facturas_demo, total_general=total_general)
